...
export function ExplorePost({ content }) {
                                ...
                                <div className="col-md-8">
                                    {content["is_content_video"] ?
                                        <VisibilitySensor onChange={(isVisible) => setIsVisible(isVisible)}>
                                            <video ref={videoRef} className="img-fluid round" src={content["content_video_pic"]} type='video/mp4' controls loop />
                                        </VisibilitySensor> : <img className="img-fluid round" src={content["content_video_pic"]} />}
                                </div>
                                : <></>}
                            <div className={(content["content_video_pic"] != "NO-PIC") ? "col-md-4" : "col-md-14"}>
                                <div className="card-body">
                                    <Friendlist online={"e"} content={content} />
                                    <p className="postContent">{content["content_text"]}</p>
